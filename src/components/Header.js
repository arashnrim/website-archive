...
const Header = () => (
  <>
    ...
    >
      ...
      <div
        className="transition-all flex flex-1 flex-col md:flex-row items-end md:items-start md:justify-end gap-6 md:gap-0 md:gap-x-6 font-mono"
        id="menu-links"
      >
        <button className="w-min md:hidden justify-self-end" id="menu-button" aria-label="Menu">
          <FontAwesomeIcon icon={faBars} size="lg" />
        </button>
        <Link
          to="/"
          className="hidden md:inline font-regular"
