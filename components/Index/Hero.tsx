...
const Hero = () => {
  return (
    <motion.section
      className="flex flex-col lg:flex-row justify-center items-center min-h-screen min-w-screen px-10 md:px-12 lg:px-20 space-y-10 lg:space-y-0 lg:space-x-16 bg-black rounded-b-3xl"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
